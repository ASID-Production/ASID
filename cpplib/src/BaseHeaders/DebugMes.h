...
/**
         * Create a scope guard that logs the beginning of a named interface scope and increases indentation.
         *
         * Prints the current indentation, outputs "[START] " followed by the provided name to std::cerr,
         * and increments debug::LogDepth::level so nested guards are indented.
         *
         * @param n Name of the interface or scope to log.
         */
        namespace debug {
    struct LogDepth {
